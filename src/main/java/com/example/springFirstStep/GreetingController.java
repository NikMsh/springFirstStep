...
import com.example.springFirstStep.repository.UserRepository;
...
public class GreetingController {
    ...
    public String filterByName(@RequestParam String findName, Map<String, Object> model) {
        Iterable<User> users;
        if (findName!=null && !findName.isEmpty()) {
            users = userRepository.findByName(findName);
        } else {
